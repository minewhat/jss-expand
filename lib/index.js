...
function objectToArray(value, prop, rule, isFallback, isInArray) {
  ...
  if (_props.customPropObj[prop]) {
    ...
    if (extraValue) {
      customPropsToStyle(extraValue, rule, _props.customPropObj[prop], isFallback);
    }
  }
...
function jssExpand() {
  function onChangeValue(newValue, prop, rule) {
    if (!Array.isArray(newValue) && (typeof newValue === 'undefined' ? 'undefined' : _typeof(newValue)) === 'object') {
